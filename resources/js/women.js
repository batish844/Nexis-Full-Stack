$(document).ready(function() {
  ...
  // Fetching product data from women.json and rendering products
  $.getJSON('', function(productsData) {
  ...
  function saveItemToCart(item) {
      let cart = localStorage.getItem('cart') ? JSON.parse(localStorage.getItem('cart')) : [];//retrieves current cart or creates a new one
      cart.push(item);
      localStorage.setItem('cart', JSON.stringify(cart));//It converts the cart array back into a JSON-formatted string
  }
