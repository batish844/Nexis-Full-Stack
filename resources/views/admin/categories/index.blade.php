...
<div class="container p-6">
    ...
    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0 mb-8">
        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 items-center">
            ...
            <label for="categoryfilter" class="text-gray-600">Sort by Items:</label>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200 shadow-lg rounded-lg overflow-hidden text-center">
            <thead class="bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
                ...
                <tr class="text-sm uppercase tracking-wider">
                    ...
                    <th class="px-6 py-3 font-semibold">Associated Items</th>
